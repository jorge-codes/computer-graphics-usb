...
// 01. plain and simple flat shader
import vertexShader from './shaders/vertex.glsl';
import fragmentShader from './shaders/fragment.glsl';
// 02. simple texture mapping via shaders (remember to use the box texture)
// import vertexShader from './shaders/vertex.glsl';
// import fragmentShader from './shaders/texture.glsl';
// 03. texture mapping + shading via varyings for flag effect
// import vertexShader from './shaders/flag_vert.glsl';
// import fragmentShader from './shaders/flag_frag.glsl';
...
class App {
  ...
  constructor() {
    ...
    // 01. box geometry for flat shading and box texture map
    this.geometry = new THREE.BoxGeometry(1, 1, 1, 32, 32, 32);
    // 02. sphere geometry for explaining unwrapping
    // this.geometry = new THREE.SphereGeometry(0.5, 64, 64);
    // 03. plane geometry for flag
    ...
    const flagTexture = textureLoader.load('static/img/flag-venezuela.png');
